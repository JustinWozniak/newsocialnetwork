    ...
    <main id="main">
        ...
        <section class="cover-wrap " style="padding: 95px 0 30px 0px;">
            ...
            <div class='row follow-details d-flex justify-content-center align-items-center p-2' style="background-color:white">
                ...
                <div class="followers-count d-flex flex-column  justify-content-center align-items-center mr-5"><span class="text-secondary ">Following</span><span class="text-secondary font-weight-bold" style="font-size:20px"><?php if (empty($followingCount)) {
                                                                                                                                                                                                                                        echo '0';
                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                        echo count($followingCount);
                                                                                                                                                                                                                                    } ?></span></div>
                <div class="following-count d-flex flex-column justify-content-center align-items-center"><span class="text-secondary">Followers</span><span class="text-secondary font-weight-bold" style="font-size:20px"><?php if (empty($followerCount)) {
                                                                                                                                                                                                                                echo '0';
                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                echo count($followerCount);
                                                                                                                                                                                                                            } ?></span></div>
                    ...
                    <div class="col-lg-3 card" style="background-color: #f8f9fa87 !important;padding-top:10px;">
                        ...
                        <div class="mobile-foll" style="margin-bottom:10px;">
                            <div class="mobile-following" style=" color:gray;">
                                <snap style="font-weight:600; color:black;margin-right: 5PX;"><?php if (empty($followingCount)) {
                                                                                                    echo '0';
                                                                                                } else {
                                                                                                    echo count($followingCount);
                                                                                                } ?></snap>Following
                            ...
                            <div class="mobile-follower" style=" color:gray;">
                                <snap style="font-weight:600;margin-right:5px; color:black;margin-left:10px;"><?php if (empty($followerCount)) {
                                                                                                                    echo '0';
                                                                                                                } else {
                                                                                                                    echo count($followerCount);
                                                                                                                } ?></snap>Followers
